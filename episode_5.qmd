...
![Count density plots after voom](images/countDensityAfterVoom.png)
...
The fit object is complex to look at. We will use the topTable function to retrieve the useful information (gene name, logFC, adjusted p values), and then filter for significant genes only.
...
Volcano plots are a useful and commonly used method to visualise differentially expressed genes within your data set. We will produce the plot over multiple steps,
but in practice you would jump straight to the final plot. 
...
![Significantly differentially expressed genes with Limma](images/limmaSigDiffExpressed.png)
