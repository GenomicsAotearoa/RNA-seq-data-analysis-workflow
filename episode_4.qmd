...
Exploratory analysis is a new section in this workflow, and will cover basic visualisations and characterisations of the data, then any initial transformations (*e.g.,* library size) required before DGE. 
