...
Where you are working will dictate what you need to install and how you will need to go about it, therefore this document does not include instructions to install software. 


### Attribution notice

This workshop was produced based on an earlier version of RNA-seq data analysis by Genomics Aotearoa and NeSI [linkedHere](). It incorporates, and takes inspiration from, various training materials produced by the Harvard Bioinformatics Core: [visit their github](https://github.com/hbctraining). 